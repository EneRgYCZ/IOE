...
Route::group(['prefix' => 'equipment', 'as' => 'equipment.'], function () {
    ...
    Route::get('/laptops', [\App\Http\Controllers\EquipmentController::class, 'laptopsIndex'])->name('laptops');
    Route::get('/meeting-room-laptops', [\App\Http\Controllers\EquipmentController::class, 'meetingRoomLaptopIndex'])->name('meeting-room-laptops');
